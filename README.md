...
As an alternative to using [vim-plug](https://github.com/junegunn/vim-plug) as shown above, clone [LanguageClient-neovim](https://github.com/autozimu/LanguageClient-neovim)
